---
title: Modulo de Compras (COM)
description: Documentacao completa do modulo de Compras (SIGACOM) do TOTVS Protheus - ciclo de aquisicao, tabelas, rotinas, regras de negocio e integracoes
---
