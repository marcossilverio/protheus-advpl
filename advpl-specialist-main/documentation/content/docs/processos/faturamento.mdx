---
title: Modulo de Faturamento (FAT)
description: Documentacao completa do modulo de Faturamento (SIGAFAT) do TOTVS Protheus - ciclo de vendas, pedidos, liberacao, NF-e e integracoes
---
