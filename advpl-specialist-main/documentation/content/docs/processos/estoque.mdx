---
title: Modulo de Estoque (EST)
description: Documentacao completa do modulo de Estoque (SIGAEST) do TOTVS Protheus - controle de materiais, movimentacoes, inventario, custos e integracoes
---
